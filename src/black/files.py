...
def wrap_stream_for_windows(
    ...
    """
    # colorama_wrap_stream is imported at the top for faster access, no need to import each time.
    return colorama_wrap_stream(f, convert=None, strip=False, autoreset=False, wrap=True)
